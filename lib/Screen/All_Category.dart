...
class _AllCategoryState extends State<AllCategory> {
  ...
  Future<void> getCat() async {
    ...
    apiBaseHelper.postAPICall(getCatApi, parameter).then((getdata) {
      ...
      print("11111111111111111111111111${getCatApi}");
      print("11111111111111111111111111${parameter}");
      if (!error) {
  ...
  subCatItem(List<Product> subList, int index, BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context)=>SellerList(getByLocation: false, catId: subList[index].id!,)));
